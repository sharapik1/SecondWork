...
namespace wpf_timba.Model
{
    public class LocalDataProvider : IDataProvider
    {
        ...
        public IEnumerable<Book> GetBooks()
        {
            return new Book[]
            {
                new Book{NameAvtor = "Николай Семенович Лесков", Izdatelstvo = "Николай Семенович Лесков", NameBook = "Левша", Year = 1881, Stranitsi = 279, Janr = "Драма" },
